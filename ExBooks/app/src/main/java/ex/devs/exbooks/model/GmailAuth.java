...
public class GmailAuth {
    ...
    public void throwInOnActivityResult(Intent data){
        ...
        try {
            ...
            Toast.makeText(loginPresenterInterface.getContext(), e.getMessage(), Toast.LENGTH_SHORT).show();
                ...
                .addOnCompleteListener((Activity) loginPresenterInterface.getContext(), new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            //Toast.makeText(loginPresenterInterface.getContext(), task.getException().getMessage(), Toast.LENGTH_SHORT).show();
